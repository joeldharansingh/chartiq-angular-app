...
module.exports = {
	entry: "./src/sample-template-native-sdk-webpack.js",
	mode: env,
	module: {
		/**
		...
		rules: [
			/**
			 * Provides support for import.meta for webpack 4.
			 * Without this plugin the build will fail.
			 * Read more about webpack-import-meta-loader:
	...
	plugins: [
		 ...
		 */
		new CssPlugin({
			filename: "./css/chartiq-styles.css"
		}),
		/**
