...
declare module '../js/chartiq.js' {
  ...
  export namespace quotefeed {
     ...
     *
     * <b>Note:</b> Using <code>dataCallback</code> to display a message requires that the attribution web component <em>not</em> be present in your template; otherwise the message will not display. For information on how to override the web component with custom attribution messages, see [https://documentation.chartiq.com/WebComponents.cq-attribution.html#messages.html#messages]https://documentation.chartiq.com/WebComponents.cq-attribution.html#messages.</caption>
  ...
  export namespace CIQ {
    ...
    interface ChartEngine {
       ...
       * - TBD KB 51258 Added `parameters.stretchGaps`.
       *
       ...
       * - TBD KB 51258 Added `params.stretchGaps`.
       */
      drawCandles(
        panel: CIQ.ChartEngine.Panel,
     ...
     * To save space, you may want to cherry pick the zones that you will need, and then add them in your initialization code.
     * ```
    ...
    let timeZoneMap: {
      ...
      "(UTC-03:00) Buenos Aires, Montevideo": string,
      ...
      "(UTC+02:00) Helsinki, Kyiv, Riga, Sofia, Tallinn, Vilnius": string,
      "(UTC+02:00) Cyprus": string,
      "(UTC+02:00) Beirut": string,
      "(UTC+02:00) Jerusalem": string,
      "(UTC+03:00) Istanbul": string,
      "(UTC+03:00) Damascus": string,
      "(UTC+03:00) Amman": string,
  ...
  export namespace CIQ.ChartEngine.Driver {
     ...
     *
     * Provides back-end search functionality for the [cq-lookup]WebComponents.cq-lookup
     * web component.
     *
