...
declare module '../js/chartiq.js' {
  ...
  export namespace CIQ.UI {
    ...
    class BaseComponent {
       ...
       *
       * @param params
       * @param [params.emitter] The element that will be emitting the event.  Required if not provided in `detail`.
       * @param [params.actualType] The event type that represents the user's action.  Required if not provided in `detail`.
       * @param [params.listenType="click"] The event type to dispatch to a listener on the component.
       ...
       *
       * @param root The shadow root to set up.
       *
       */
      public setupShadow(root: ShadowRoot): void
      /**
