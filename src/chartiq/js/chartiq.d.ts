...
export namespace CIQ.ChartEngine {
  ...
  class YAxis {
     ...
     * CIQ.ChartEngine#draw to activate the change.
     *
     * @param init Object containing custom values for y-axismembers
     * @example
     * // here is an example on how to override the default top and bottom margins after the initial axis has already been rendered
     * stxx.loadChart(symbol, {masterData: yourData}, function () {
     * 	// callback - your code to be executed after the chart is loaded
...
export namespace CIQ {
  ...
  class ChartEngine {
     ...
     * `stretch` will cause extended rendering in the gapped position; i.e. a "fat" candle or a horizontal line. Note: this setting acts like `gap` setting for a volume chart.
     *
     ...
     * - TBD KB 51258 Now supports "stretch" value.
     */
     ...
     * @since
     * - 6.2.5
     * - TBD KB 51258 Added parameter `forceStep`.
     */
     ...
     * @param [parameters.volume] Set to true for volume candles.
     * @param [parameters.stretchGaps] Set to true to cause gaps to be represented by a horizontal line.
     ...
     * - TBD KB 51258 added parameter `stretchGaps`.
     */
   ...
   */
  function smartHover(doc?: HTMLDocument): void
  ...
  /**
   * Configures the usage metrics client. Sets CIQ.logMetrics.
   *
   * @param newConfig New configuration object.
   * @param newConfig.clientId clientId assigned by ChartIQ; do not alter.
   * @param newConfig.url URL of reporting server. If this property is missing then usage tracking will be disabled.
   * @since 8.8.0
   */
  function configureMetricsClient(newConfig: {clientId: string, url: string}): void
}
